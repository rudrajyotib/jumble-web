        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', flex: 1 }}>
                <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                    <CountDownTimer saveTimerProgressConfiguration={this.props.saveTimerProgressConfiguration} duration={this.props.durationInSeconds} onTimeOut={() => { this.props.timeOutHandler() }} />
                </div>
